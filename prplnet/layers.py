...
Each layer needs to pass its inputes forward
and propagate gradients backward. For example,
a neural net might look like

inputs -> Linear -> Tanh -> Linear -> output
"""
#TODO: #8 Add more activation layers
#TODO: #7 Add different layers (Convolutional, Recurrent - LSTMs)
import numpy as np
...
class Linear(Layer):
    ...
    def backward(self, grad: Tensor) -> Tensor:
        ...
        and dy/db = a.T @ f'(x)
        and dy/dc = f'(x)
        ... then sum across batch dimension
        """
